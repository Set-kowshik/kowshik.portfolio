...
const techStack = [
  ...
  { name: 'Framer', color: 'text-blue-400' },
  { name: 'Photoshop', color: 'text-cyan-400' },
  { name: 'Illustrator', color: 'text-orange-400' },
  { name: 'React', color: 'text-blue-300' },
  { name: 'TypeScript', color: 'text-blue-500' },
  { name: 'GSAP', color: 'text-green-400' },
  { name: 'Three.js', color: 'text-yellow-400' },
];
          ...
          <div ref={contentRef} className="space-y-8">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                ...
                <p>
                  With expertise in modern design tools and cutting-edge web technologies, I bring 
                  concepts to life through innovative animations, 3D elements, and seamless user 
                  experiences. My work spans across web applications, mobile interfaces, and 
            ...
            <div ref={iconsRef}>
              ...
              <div className="grid grid-cols-4 gap-4">
                {techStack.map((tech, index) => (
                  <div
                    key={tech.name}
                    className="tech-icon glass rounded-lg p-4 text-center hover:glass-elevated transition-all duration-300 group cursor-pointer"
                  >
                    <div className={`text-2xl font-bold ${tech.color} mb-2 group-hover:scale-110 transition-transform`}>
                      {tech.name.charAt(0)}
                    </div>
